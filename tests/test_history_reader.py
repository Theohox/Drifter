...
class TestHistoryReaderAutoDetect:
    def test_from_shell_env_bash(self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_from_shell_env_zsh(self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_from_shell_env_fish(self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_from_explicit_env_var(self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_no_history_found(self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
        monkeypatch.setenv("HOME", str(tmp_path))
    ...
    def test_fallback_order(self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
